...
const C1 = [
  ...
  {id:"c1_02",sn:2, n:"Python Fundamentals + Control Flow",   m:133,cat:"Python",            d:"must_do"},
  {id:"c1_03",sn:3, n:"Data Structures",                      m:129,cat:"Python",            d:"must_do"},
  {id:"c1_04",sn:4, n:"Functions",                            m:82, cat:"Python",            d:"must_do"},
  {id:"c1_05",sn:5, n:"Practice Questions (Functions + DS)",  m:0,  cat:"Practice",          d:"must_do"},
  {id:"c1_06",sn:6, n:"Modules & Packages",                   m:35, cat:"Python",            d:"must_do"},
  {id:"c1_07",sn:7, n:"File Handling",                        m:26, cat:"Python",            d:"must_do"},
  {id:"c1_08",sn:8, n:"Exception Handling",                   m:25, cat:"Python",            d:"must_do"},
  {id:"c1_09",sn:9, n:"OOP — Classes & Objects",              m:116,cat:"Python",            d:"must_do"},
  {id:"c1_10",sn:10,n:"Advanced Python",                      m:39, cat:"Python",            d:"must_do"},
  {id:"c1_11",sn:11,n:"Data Analysis (NumPy / Pandas / Viz)", m:147,cat:"Data Analysis",     d:"must_do"},
  {id:"c1_12",sn:12,n:"SQLite3",                              m:17, cat:"Database",          d:"optional"},
  {id:"c1_13",sn:13,n:"Logging in Python",                    m:27, cat:"Python Advanced",   d:"optional"},
  {id:"c1_14",sn:14,n:"Multi-Threading & Processing",         m:56, cat:"Python Advanced",   d:"optional"},
  {id:"c1_15",sn:15,n:"Memory Management",                    m:21, cat:"Python Advanced",   d:"optional"},
  {id:"c1_16",sn:16,n:"Flask Framework",                      m:106,cat:"Web",               d:"optional"},
  {id:"c1_17",sn:17,n:"Streamlit",                            m:26, cat:"Web",               d:"must_do"},
  {id:"c1_18",sn:18,n:"Statistics Fundamentals",              m:144,cat:"Statistics",         d:"must_do"},
  {id:"c1_19",sn:19,n:"Probability",                          m:22, cat:"Statistics",         d:"must_do"},
  {id:"c1_20",sn:20,n:"Probability Distributions",            m:180,cat:"Statistics",         d:"must_do"},
  {id:"c1_21",sn:21,n:"Inferential Statistics",               m:151,cat:"Statistics",         d:"must_do"},
  {id:"c1_22",sn:22,n:"Feature Engineering",                  m:84, cat:"EDA / FE",           d:"must_do"},
  {id:"c1_23",sn:23,n:"EDA + Feature Engineering",            m:99, cat:"EDA / FE",           d:"must_do"},
  {id:"c1_24",sn:24,n:"ML Introduction",                      m:61, cat:"ML Foundations",     d:"must_do"},
  {id:"c1_25",sn:25,n:"Linear Regression (In-depth)",         m:255,cat:"Supervised ML",      d:"must_do"},
  {id:"c1_26",sn:26,n:"Ridge / Lasso / ElasticNet",           m:130,cat:"Supervised ML",      d:"must_do"},
  {id:"c1_27",sn:27,n:"ML Lifecycle Project",                 m:164,cat:"ML Projects",        d:"must_do"},
  {id:"c1_28",sn:28,n:"Logistic Regression",                  m:127,cat:"Supervised ML",      d:"must_do"},
  {id:"c1_29",sn:29,n:"Support Vector Machines",              m:104,cat:"Supervised ML",      d:"must_do"},
  {id:"c1_30",sn:30,n:"Naive Bayes",                          m:56, cat:"Supervised ML",      d:"must_do"},
  {id:"c1_31",sn:31,n:"KNN",                                  m:37, cat:"Supervised ML",      d:"must_do"},
  {id:"c1_32",sn:32,n:"Decision Tree",                        m:107,cat:"Supervised ML",      d:"must_do"},
  {id:"c1_33",sn:33,n:"Random Forest",                        m:85, cat:"Supervised ML",      d:"must_do"},
  {id:"c1_34",sn:34,n:"AdaBoost",                             m:70, cat:"Supervised ML",      d:"must_do"},
  {id:"c1_35",sn:35,n:"Gradient Boosting",                    m:34, cat:"Supervised ML",      d:"must_do"},
  {id:"c1_36",sn:36,n:"XGBoost",                              m:64, cat:"Supervised ML",      d:"must_do"},
  {id:"c1_37",sn:37,n:"Unsupervised ML Intro",                m:8,  cat:"Unsupervised ML",    d:"must_do"},
  {id:"c1_38",sn:38,n:"PCA",                                  m:89, cat:"Unsupervised ML",    d:"must_do"},
  {id:"c1_39",sn:39,n:"KMeans Clustering",                    m:49, cat:"Unsupervised ML",    d:"must_do"},
  {id:"c1_40",sn:40,n:"Hierarchical Clustering",              m:33, cat:"Unsupervised ML",    d:"must_do"},
  {id:"c1_41",sn:41,n:"DBSCAN",                               m:25, cat:"Unsupervised ML",    d:"must_do"},
  {id:"c1_42",sn:42,n:"Silhouette / Cluster Eval",            m:9,  cat:"Unsupervised ML",    d:"must_do"},
  {id:"c1_43",sn:43,n:"Anomaly Detection",                    m:38, cat:"Unsupervised ML",    d:"must_do"},
  {id:"c1_44",sn:44,n:"Docker",                               m:99, cat:"MLOps",              d:"must_do"},
  {id:"c1_45",sn:45,n:"Git",                                  m:51, cat:"MLOps",              d:"must_do"},
  {id:"c1_46",sn:46,n:"ML Deployment Project (AWS/Azure)",    m:315,cat:"MLOps",              d:"must_do"},
  {id:"c1_47",sn:47,n:"Advanced MLOps + ETL Pipeline",        m:461,cat:"MLOps",              d:"optional"},
  {id:"c1_48",sn:48,n:"MLFlow, Dagshub & BentoML",            m:94, cat:"MLOps",              d:"must_do"},
  {id:"c1_49",sn:49,n:"Classical NLP",                        m:385,cat:"NLP",               d:"must_do"},
  {id:"c1_50",sn:50,n:"Deep Learning Theory",                 m:404,cat:"Deep Learning",      d:"must_do"},
  {id:"c1_51",sn:51,n:"ANN End-to-End Project",               m:137,cat:"Deep Learning",      d:"must_do"},
  {id:"c1_52",sn:52,n:"NLP + Deep Learning Intro",            m:18, cat:"NLP Deep Learning",  d:"must_do"},
  {id:"c1_53",sn:53,n:"Simple RNN",                           m:103,cat:"NLP Deep Learning",  d:"must_do"},
  {id:"c1_54",sn:54,n:"RNN End-to-End Project",               m:79, cat:"NLP Deep Learning",  d:"must_do"},
  {id:"c1_55",sn:55,n:"LSTM & GRU (In-depth)",                m:126,cat:"NLP Deep Learning",  d:"must_do"},
  {id:"c1_56",sn:56,n:"LSTM / GRU Project",                   m:46, cat:"NLP Deep Learning",  d:"must_do"},
  {id:"c1_57",sn:57,n:"Bidirectional RNN",                    m:23, cat:"NLP Deep Learning",  d:"must_do"},
  {id:"c1_58",sn:58,n:"Encoder-Decoder / Seq2Seq",            m:41, cat:"NLP Deep Learning",  d:"must_do"},
  {id:"c1_59",sn:59,n:"Attention Mechanism",                  m:29, cat:"NLP Deep Learning",  d:"must_do"},
  {id:"c1_60",sn:60,n:"Transformers (In-depth)",              m:302,cat:"NLP Deep Learning",  d:"must_do"},
  {id:"c1_61",sn:61,n:"Role Play / Interview Mock",           m:0,  cat:"Extra",              d:"optional"},
];
